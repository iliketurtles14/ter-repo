    ...
    public class GameData
    {
        ...
        public void Read(ByteReader reader)
        {
            ...
            while (true)
            {
                ...
                if (chunkData == null)
                {
                    Logger.Log($"Skipping chunk {newChunk.Id} due to null data", true, ConsoleColor.Yellow);
                    continue;
                }
                ...
                {
                    Logger.Log($"Error reading chunk {newChunk.Id}: {ex.Message}", true, ConsoleColor.Red);
                }
            }
