...
public class FoodPickUp : MonoBehaviour
{
    ...
    private void Update()
    {
        if(mcs.isTouchingFoodTable && Input.GetMouseButtonDown(0) && mcs.touchedFoodTable.GetComponent<FoodTableCounter>().foodCount > 0 && !player.GetComponent<PlayerCollectionData>().playerData.hasFood)
        {
