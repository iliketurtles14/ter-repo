...
public class BodyController : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        BuddyLists.Add(new List<Sprite>());
        ...
        BlackElfLists.Add(new List<Sprite>());
        ...
        BlondeLists.Add(new List<Sprite>());
        ...
        BrownElfLists.Add(new List<Sprite>());
        ...
        CraneLists.Add(new List<Sprite>());
        ...
        ElbrahLists.Add(new List<Sprite>());
        ...
        GenieLists.Add(new List<Sprite>());
        ...
        HenchmanLists.Add(new List<Sprite>());
        ...
        IceElfLists.Add(new List<Sprite>());
        ...
        LazeeboiLists.Add(new List<Sprite>());
        ...
        MournLists.Add(new List<Sprite>());
        ...
        OrangeElfLists.Add(new List<Sprite>());
        ...
        PiersLists.Add(new List<Sprite>());
        ...
        PinkElfLists.Add(new List<Sprite>());
        ...
        ProwlerLists.Add(new List<Sprite>());
        ...
        SoldierLists.Add(new List<Sprite>());
        ...
        GuardElfLists.Add(new List<Sprite>());
        ...
        WaltonLists.Add(new List<Sprite>());
        ...
        WhiteElfLists.Add(new List<Sprite>());
        ...
        YellowElfLists.Add(new List<Sprite>());
