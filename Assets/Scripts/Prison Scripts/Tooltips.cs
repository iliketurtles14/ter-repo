		...
		switch (changeType)
		{
			...
			case "tileDurability":
				switch (tooltipType)
				{
					...
					case "electricFence": InventoryCanvas.transform.Find("TooltipText(Clone)").GetComponent<TextMeshProUGUI>().text = toPrint + " (" + mcs.touchedElectricFence.GetComponent<TileCollectionData>().tileData.currentDurability + "%)"; break;
