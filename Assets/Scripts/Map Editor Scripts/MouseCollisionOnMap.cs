...
public class MouseCollisionOnMap : MonoBehaviour
{
    ...
    public bool isTouchingMover;
    public GameObject touchedMover;
    public bool isTouchingBlack;
    public GameObject touchedBlack;
    public bool isTouchingZone;
    public GameObject touchedZone;
    ...
    private void Update()
    {
        ...
        if(highestPriorityObject != null)
        {
            ...
            {
                case "Black":
                    isTouchingBlack = true;
                    touchedBlack = highestPriorityObject;
                    break;
                case "Button":
                ...
                case "Object":
                    ...
                    break;
                case "Mover":
                    isTouchingMover = true;
                    touchedMover = highestPriorityObject;
                    break;
                case "Handle":
                ...
                case "Zone":
                    isTouchingZone = true;
                    touchedZone = highestPriorityObject;
                    break;
                case "Menu":
                    isTouchingMenu = true;
                    touchedMenu = highestPriorityObject;
                    break;
            }
        }
    }
    ...
    private void ClearCollisions()
    {
        ...
        touchedHandle = null;
        isTouchingMover = false;
        touchedMover = null;
        isTouchingBlack = false;
        touchedBlack = null;
